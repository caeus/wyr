...
missingTransitive.wire(repo);
//                     ^^^^
// TS2345: Argument of type 'typeof repo' is not assignable to parameter of type
// 'Err<"missing key", { key: unique symbol; trace: readonly [unique symbol]; }>'.
```
...
circular.wire(a);
//            ^
// TS2345: Argument of type 'typeof a' is not assignable to parameter of type
// 'Err<"circular dependency", { key: unique symbol; trace: readonly [...] }>'.
```
